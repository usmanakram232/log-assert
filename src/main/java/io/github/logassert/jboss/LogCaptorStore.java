...
public final class LogCaptorStore {
   ...
   *
   * <p>Synchronized against {@link #append} and {@link #clear} to ensure the returned list reflects
   * a consistent state and never contains entries that were concurrently evicted by a {@code
   * clear()} call in progress.
   *
